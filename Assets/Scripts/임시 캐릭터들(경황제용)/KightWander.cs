...
public class KnightWander : Player, IPunObservable
{
    ...
    void Atk1()
    {
        ...
        StartCoroutine(SetCollider(3f, 2f, 6.8f, 4.5f, 0.15f));
    }
    ...
    void Atk2()
    {
        ...
        StartCoroutine(SetCollider(2.7f, 2.3f, 6f, 5f, 0.2f));
    }
    ...
    void AtkD()
    {
        ...
        StartCoroutine(SetCollider(1.25f, -0.1f, 3f, 1.5f, 0.15f));
        // 대쉬
        Dash(10);
    }
    ...
    public void Cmd1(InputAction.CallbackContext context) // z -> <- z
    {
        ...
        StartCoroutine(SetCollider(2.9f, 1.5f, 6.3f, 3f, 0.15f));
    }
